<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Tour.Master"  CodeBehind="Login.aspx.cs" Inherits="Site.Login" %>
       ...
       <table align="center" class="">
           ...
           <tr>
               ...
               <td ><br />
                  <asp:Button ID="lgbtnlogin" runat="server" Text="Login" CssClass="btn btn-primary " Width="200px" OnClick="lgbtnlogin_Click" />
               
           
           
             
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                  <asp:Button ID="lgbtnClear"  runat="server" Text="Clear" CssClass="btn btn-danger " Width="200px"  CausesValidation="False" UseSubmitBehavior="False" OnClick="lgbtnClear_Click" />
               </td>
           </tr>
           <tr>
               <td colspan="2" align="center">
                   <br /><asp:LinkButton ID="reglink" runat="server" OnClick="reglink_Click" CausesValidation="False"><h4><u>Register Here</u></h4></asp:LinkButton>
               </td>
           </tr>
