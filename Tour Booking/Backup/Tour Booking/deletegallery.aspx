...
&nbsp;<asp:TextBox ID="place_name" runat="server"  class="form-control"  aria-describedby="emailHelp" ReadOnly="true"></asp:TextBox>
               ...
               <div class="mb-3 col-12">
                   ...
                   <asp:Image ID="Image1" runat="server" height="100px" Width="100px" />
                    <div class="mb-3 col-12">
    <label for="exampleInputEmail1" class="form-label">Place Price:</label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="price" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
