    ...
    <table align="center">
        ...
        <tr>
           ...
           <tr>
               ...
               <td >
                  <asp:Button ID="rgbtnregister" runat="server" Text="Register" CssClass="btn btn-primary" Width="200px" OnClick="rgbtnregister_Click" />
          
             
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <asp:Button ID="rgbtnClear" runat="server" Text="Clear" CssClass="btn btn-danger" Width="200px" OnClick="rgbtnClear_Click" UseSubmitBehavior="False" CausesValidation="False" />
               </td>
           </tr>
        <tr>
            <td colspan="2" align="center">
               <br /><asp:LinkButton ID="login" runat="server" OnClick="login_Click" CausesValidation="False"><h4><u>Login Here</u></h4>
                  </asp:LinkButton>
            </td>
        </tr>
